...
We freeze the preceding prediction path and optimize the adapter, new-class pathway, and calibration scalars on the mixed incremental training set $\mathcal{S}_t=\mathcal{B}_{t-1}\cup\mathcal{D}_t$ with the following composite loss:
\begin{align}
