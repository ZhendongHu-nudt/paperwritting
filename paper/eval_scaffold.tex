...
Table~\ref{tab:ablation} reports three component-level ablations on NUDT-Mobile. Removing the reconstruction routing signal raises forgetting by 5.78\,pp; reverting to a single head raises forgetting by 4.49\,pp and drops mix by 9.77\,pp; removing calibration raises forgetting by 3.41\,pp. These results quantify the effect of each component as implemented in the complete framework; the routing ablation removes both loss weighting and logit gating and therefore does not attribute the gain to either use in isolation.
